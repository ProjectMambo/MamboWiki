...
- A parallel AGS 3 per-monitor bar, Apps/Run/Windows/Power launcher, and two focused-monitor sidebars, with Waybar, Rofi, and Mako retained as active fallbacks.
